...
async function main() {
  ...
  // Limpia productos existentes y recarga para que las imágenes se actualicen
  await prisma.producto.deleteMany({});
  await prisma.producto.createMany({ data: productos });

  console.log("Seed completado: usuarios admin/user y catálogo con imágenes actualizadas.");
}
